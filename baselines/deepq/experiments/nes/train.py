...
from baselines.common.nes_wrappers_deprecated import wrap_dqn
from baselines.common.azure_utils import Container
from .model import model, dueling_model


def parse_args():
    parser = argparse.ArgumentParser("DQN experiments for NES games")
    # Environment
    parser.add_argument("--env", type=str, default="super_mario_bros", help="name of the game")
...
def make_env(game_name):
    env = gym.make("{}-NoFrameskip".format(game_name))
